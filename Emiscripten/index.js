...
// include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpfzugikw2.js
...
Module['FS_createPath']("/", "Emiscripten", true, true);
    ...
    loadPackage({"files": [{"filename": "/Emiscripten/fShader.fs", "start": 0, "end": 1213}, {"filename": "/Emiscripten/horse.obj", "start": 1213, "end": 131866}, {"filename": "/Emiscripten/vShader.vs", "start": 131866, "end": 132417}], "remote_package_size": 132417});

  })();

// end include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpfzugikw2.js
// include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpovtr4g70.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpovtr4g70.js
// include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpprqm3e0p.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/80/x292h16x2g11d76t_dw3kx4r0000gn/T/tmpprqm3e0p.js
